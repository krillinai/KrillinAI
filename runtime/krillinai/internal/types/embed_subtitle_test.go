...
func TestAssHeaderVerticalKeepsBilingualLinesCloseTogether(t *testing.T) {
	...
	if majorMargin <= minorMargin {
		t.Fatalf("vertical Major subtitle should render above Minor: major MarginV=%d minor MarginV=%d", majorMargin, minorMargin)
	}
	if majorMargin-minorMargin > 10 {
